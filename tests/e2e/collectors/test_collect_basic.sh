...
collect_output=$(run_vc collect --collector fallback_probe 2>&1) || {
...
collect_output2=$(run_vc collect --collector fallback_probe 2>&1) || {
...
collect_output3=$(run_vc collect --machine local 2>&1) || {
